...
void function () {
  ...
  // Simulate Keydown
  utils.simulateKeydown = function (keyName) {
  ...
  var KeyboardListener = function () {
    ...
    function KeyboardListener(options) {
      ...
      var throttledHandleKeydown = throttle(this.handleKeydown.bind(this), 168, {
        trailing: false
      });

      // Attach event listeners
      window.addEventListener('keydown', function (e) {
        return throttledHandleKeydown(e);
      });
  ...
  var ModalView = function (_BaseView) {
    ...
    _createClass(ModalView, [{
      ...
      value: function handleCloseClick() {
        ...
        var simulateKeydown = utils.simulateKeydown;
  ...
  var SceneView = function (_BaseView5) {
    ...
    _createClass(SceneView, [{
      key: 'style',
      value: function style() {
        var svZIndexScene = this.sv.svZIndexScene;
        ...
        return this.csjs(_templateObject5, svZIndexScene, svTextCellSize, svTextCellUnit, svTextCellSize, svTextCellUnit, svTextCellSize, svTextCellUnit);
      }
    }, {
      key: 'render',
      value: function render() {
  ...
  // Store instance
  var store = new Store(middlewares.logger, middlewares.linked, middlewares.soundSpawn(soundManager));
  ...
  var Game = function () {
    ...
    _createClass(Game, [{
      ...
      value: function _handlePlayerKeydown(e) {
        var keymap = utils.keymap;
        var keyboardShortcuts = this.props.keyboardShortcuts;
        var status = this.state.status;


        var inputKeyName = keymap(e.keyCode);
