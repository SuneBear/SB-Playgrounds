...
void function () {
   ...
   * DotsTrump Class
   */
  var DotsTrump = function DotsTrump() {
  ...
  Project.prototype.mountImageUploader = function () {
    ...
    this.$uploadImageBtn.addEventListener('click', function () {
      input.click();
    }, false);
  ...
  Project.prototype.sourceToFilteredImage = function () {
    ...
    utils.getBase64FromImageUrl(this.states.sourceImage, function (url, canvas) {
      ...
      var filteredImageData = dotsTrump.src(sourceImageData).pipe(canvasFilters.grayscale, self.states.filterOptions).pipe(canvasFilters.contrast, self.states.filterOptions).pipe(canvasFilters.brightness, self.states.filterOptions).pipe(canvasFilters.dottify, self.states.filterOptions).value();
